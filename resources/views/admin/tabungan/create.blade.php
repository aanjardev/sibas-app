...
@section('content')
<form action="#" method="POST" id="create-tabungan-form">
    @csrf
                        ...
                        <div class="mt-3 p-3 bg-success bg-opacity-10 border border-success border-opacity-25 rounded-3 d-flex justify-content-between align-items-center d-none" id="selected-member-card">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="text-muted text-xs">Saldo Saat Ini: <b class="text-dark" id="saldo_awal_text">Rp 250.000</b></span>
                                </div>
                            </div>
                ...
                <div class="admin-card-body p-3 p-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="1000" min="1000" class="form-control text-sm fw-bold text-dark fs-5" id="nominal" name="nominal" placeholder="0" required oninput="calculateEstimasi()">
                        </div>
                    </div>

                    <div class="mb-4">
                        <label for="keterangan" class="form-label fw-semibold text-sm">Catatan / Keterangan (Opsional)</label>
                        <textarea class="form-control text-sm" id="keterangan" name="keterangan" rows="2" placeholder="Contoh: Setor tunai mandiri / Penarikan tunai keperluan mendesak"></textarea>
                    </div>
                    ...
                    <div class="p-3 p-md-4 rounded-3 border bg-light" id="projection-card">
                        <div class="row align-items-center g-3">
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <span class="fs-3 fw-bold text-success" id="saldo_akhir_display">Rp 250.000</span>
                            </div>
                        </div>
                    </div>
                </div>
