    ...
    <div class="row g-3 mb-3 mb-md-4">
        <div class="col-12 d-flex align-items-center justify-content-between gap-2">
            ...
            <div class="d-flex align-items-center gap-2">
                <span class="badge bg-light text-dark border d-none d-sm-inline-block">SKU: PRD-001</span>
                ...
                <div class="admin-card-body p-3 p-md-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex flex-column flex-sm-row align-items-center gap-3">
                            <div class="rounded-3 border bg-light d-flex align-items-center justify-content-center flex-shrink-0" id="photo-preview-box" style="width: 110px; height: 110px;">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" class="form-control text-sm" id="sku" name="sku" value="PRD-001" readonly>
                        </div>
                        <div class="col-12 col-md-8">
                            <label for="nama_produk" class="form-label fw-semibold text-sm">Nama Produk <span class="text-danger">*</span></label>
                            <input type="text" class="form-control text-sm" id="nama_produk" name="nama_produk" value="Minyak Goreng Sawit 1L" required>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-12 col-md-6">
                            ...
                            <select class="form-select text-sm" id="kategori" name="kategori" required>
                                <option value="Sembako" selected>Sembako & Bahan Pokok</option>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control text-sm" id="satuan" name="satuan" value="pouch" required>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="100" min="0" class="form-control text-sm" id="harga_beli" name="harga_beli" value="14000" required>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light text-muted text-sm">Rp</span>
                                <input type="number" step="100" min="0" class="form-control text-sm fw-bold text-success" id="harga_jual" name="harga_jual" value="16500" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="number" min="0" class="form-control text-sm" id="stok" name="stok" value="45" required>
                        </div>
                        <div class="col-12 col-md-6">
                    ...
                    <div class="mb-0">
                        ...
                        <textarea class="form-control text-sm" id="deskripsi" name="deskripsi" rows="3">Minyak goreng kelapa sawit olahan kualitas terbaik kemasan pouch 1000ml.</textarea>
                    </div>
                </div>
            </div>
        </div>
